                ...
                intern: [
                    {
                        ...
                        workExperience: {
                            ...
                            workPeriod: {
                                firstPeriodFrom: Timestamp.fromDate(new Date("2021-01-01T00:00:00Z")),
                                firstPeriodTo: Timestamp.fromDate(new Date("2022-12-31T23:59:59Z")),
                                secondPeriodFrom: Timestamp.fromDate(new Date("2022-01-01T00:00:00Z")),
                                secondPeriodTo: Timestamp.fromDate(new Date("2023-12-31T23:59:59Z")),
                                thirdPeriodFrom: Timestamp.fromDate(new Date("2024-01-01T00:00:00Z")),
                                thirdPeriodTo: Timestamp.fromDate(new Date("2025-12-31T23:59:59Z")),
                            },
                            position: {
                                firstPosition: "Clerk",
